def update_status
  ...
  # Write code that changes the status of both Romeo and 
...
#   This method must only return the modified epic_tragedy hash
  epic_tragedy
end
...
def add_characters
   ...
   #
   # - Add an additional :additional_characters key to epic_tragedy and 
   #       assign it an array as its value
